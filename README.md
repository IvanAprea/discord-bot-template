This project consists of a discord bot template created using the discord.js library in version 14.13.0. This template uses ESM (The discord.js documentation uses CJS).
